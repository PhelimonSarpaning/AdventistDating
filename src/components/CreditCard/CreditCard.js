    ...
    render() {
        ...
        return (
            <View>
                ...
                <LinearGradient 
                start={{x: 0.0, y: 0.45}} end={{x: 0.5, y: 1.5}}
                locations={[0,0.8,0.5]}
                colors={['#e76402','#ed8c0e','#e97407']} style={[styles.container, { width:360,height:220, padding: sizes.base + 4, 
                    shadowColor: colors.black,
                    shadowOpacity: 0.11,
                    shadowOffset: { width: 0, height: 2 },
                    shadowRadius: 13,
                marginBottom: sizes.base }, this.props.style]}>
                <FlipCard 
                    friction={6}
                    perspective={1000}
                    flipHorizontal={true}
                        ...
                        <View style={styles.lower}>
                            ...
                            <View style={styles.info}>
                                ...
                                <View style={styles.rowWrap}>
                                    ...
                                    <Text style={styles.textSmall}>{expiryBeforeText || "CARDHOLDER'S NAME"}</Text>
                                        <Text style={styles.textName}>{this.getValue("name")}</Text></View>
                                    ...
                                    <View
                                        ...
                                        {showExpiryBeforeLabel && 
                                            <Text style={styles.textSmall}>{expiryBeforeText || 'VALID UP TO'}</Text>
                                        }
...
const styles = StyleSheet.create({
    container: {
        ...
        shadowColor: colors.black,
        shadowOpacity: 0.8,
        shadowOffset: { width: 20, height: 400 },
        shadowRadius: 13,
        elevation:1,
