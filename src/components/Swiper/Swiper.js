...
class Swiper extends Component {
    ...
    renderDownButton = () => {
        ...
        return(
            <View>
                {/* <Text onPress={() => this.swipe()} style={{left:wp('35%'),bottom:hp('-2%')}}> Start Now</Text> */}
                <Text onPress={() => this.swipeBack()} style={{left:wp('-38%'), bottom:hp('0.1%')}}> Back</Text>
      ...
      return (
        <View pointerEvents="box-none" style={[styles.buttonWrapper, styles.fullScreen]}>
          {lastScreen
            ...
            : <Text onPress={() => this.swipe()} style={{left:wp('35%')}}> Continue</Text>
